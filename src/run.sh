...
./launch_gui.sh $code_path "$micro_controller" &
./launch_motors.sh  $code_path "$micro_controller" &

##Might do this from beagle bone gui to this computer though beaglebone
